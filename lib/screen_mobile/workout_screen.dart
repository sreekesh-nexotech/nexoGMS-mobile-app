...
class _WorkoutScreenState extends State<WorkoutScreen> {
  ...
  Future<void> _loadCachedDataOrFetch() async {
    ...
    final hasCache = box.get(_workoutsKey) != null && box.get(_lastSyncKey) != null;
  ...
  Future<void> _checkForUpdates() async {
    try {
      final lastSync = Hive.box(_workoutBoxName).get(_lastSyncKey);
  ...
  Future<void> _fetchFullWorkoutData() async {
    try {
      ...
      await Hive.box(_workoutBoxName).putAll({
  ...
  void _updateUIFromCache() {
    final box = Hive.box(_workoutBoxName);
    setState(() {
      scheduleName = box.get(_scheduleNameKey, defaultValue: 'Workout Schedule');
...
Widget _buildWorkoutCard(BuildContext context, String day, String bodyPart, dynamic workoutData, int dayNumber) {
